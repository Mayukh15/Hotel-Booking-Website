...
const RoomDetails = () => {
  ...
  return   room &&(
    <div className='py-28 md:py-35 px-4 md:px-16 lg:px-24 xl:px-32'>
      ...
      {/*Room Ratings*/}
         <div className='flex items-center bgap-1 mt-2'>
          <StarRating/>
          ...
          <div className='flex flex-col'>
              ...
              <div className='flex flex-wrap items-center mt-3 mb-6 gap-4'>
                {room.amenities.map((item,index)=>(
                   <div key={index} className='flex itesm-center gap-2 px-3 py-2 rounded-lg bg-gray-100'>
  ...
  text-white rounded-md w-full md:w-auto py-3
   md:py-4 px-6 text-base font-semibold shadow-md cursor-pointer">Check Availability
</button>
         ...
         <div>
          <p className='max-w-3xl border-y border-gray-300 my-15 py-10 text-gray-500'> 
            Guests wiil be allocated on the ground floor according to the availability.You will get a 
            comfortable Two bedroom apartment has a true city feeling.The price quoted is for guests,at the guest slot please 
            mark the number of guests to get the exact prize for groups.The Guests will be allocated ground floor according to the 
            availability.You wil ger gthe two Room available giving you a true city feeling      
          </p>
         </div>
          {/*Hosted by*/}
         ...
         <div className='flex flex-col items-start gap-4'>
          ...
          <button className='px-6 py-2.5 mt-4 rounded-md text-white
           bg-blue-600 hover:bg-blue-700 active:scale-95
            transition-all shadow-md cursor-pointer font-semibold'>
            Contact now
          </button>
         </div>
    </div>
